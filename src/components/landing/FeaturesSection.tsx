...
export const FeaturesSection: React.FC = () => {
  ...
  return <section className="items-stretch flex w-full flex-col overflow-hidden px-[115px] py-14 max-md:max-w-full max-md:px-5">
      <div className="self-center flex w-[800px] max-w-full flex-col items-stretch text-neutral-800 font-normal justify-center mt-12 max-md:mt-10">
        <div className="justify-center items-center border border-[Main/Neutral/Neutral-100] self-center flex min-h-[38px] flex-col text-base tracking-[0.25px] leading-none px-4 py-[9px] rounded-[100px] border-solid">
          <div className="flex items-center gap-2 justify-center">
            <img src="https://api.builder.io/api/v1/image/assets/d0b6e100e3f94d1dbeda8e2b181952c0/251fa05c4aad3ea7da973ffe50fb5655713cd719?placeholderIfAbsent=true" className="aspect-[1] object-contain w-4 self-stretch shrink-0 my-auto" alt="" />
      ...
      <div className="flex w-full gap-3 justify-center flex-wrap mt-12 max-md:max-w-full max-md:mt-10">
        {features.map((feature, index) => <article key={index} className="bg-[rgba(0,0,0,0.001)] flex min-w-60 min-h-[296px] flex-col items-stretch justify-center grow shrink w-[274px] p-3 rounded-[36px]">
            <div className="border border-[Main/Neutral/Neutral-100] bg-white w-full flex-1 p-5 rounded-[28px] border-solid">
              <div className="w-full">
                <div className="justify-center items-center shadow-[4px_4px_10px_0_rgba(0,0,0,0.10)] flex min-h-12 w-12 gap-2.5 h-12 rounded-[100px] bg-slate-950">
                  <img src={feature.icon} className="aspect-[1] object-contain w-6 self-stretch my-auto" alt="" />
                </div>
      ...
      <Button variant="dark" size="md" className="self-center mt-12 max-md:mt-10 bg-neutral-800 text-white">
        Try It Now
      </Button>
    </section>;
};